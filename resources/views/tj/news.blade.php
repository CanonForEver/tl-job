...
あなたの得意分野で、信頼される存在に。</h3>
    ...
    <div class="clear box-action box-md text-center border-t-gray">
        ...
        <a href="http://www.find-job.net/fj/search.cgi#" data-action="search_logout" data-label="108579" class="fj-add-to-bookmark btn btn-xlg btn-secondary btn-horizontal inlin-block">关注</a>
