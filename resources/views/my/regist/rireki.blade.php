...
<div id="topic-path" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
    <ul>
        ...
        <li itemprop="child" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><strong><span itemprop="title">登録情報</span></strong></li>
    </ul>
</div><!--topic-path-->
@stop
...
<main>
    <div class="container container-narrow">
        ...
        <p class="mb40">312 様のプロフィールをご登録いただきます。<p>

        <p class="mb40"><img src="/images/edit/icon_lock.png" class="mr5">マークのついている個人を特定できる情報はスカウトサービスを利用しても企業には公開されません。<br>あなた自身が応募した企業には、すべての情報が公開されます。</p>
                ...
                <table class="input-cell mb40">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="clearfix">
                                <li class="pull-left mr10"><input name="sex" type="radio" value="1" id="man"  tabindex="103"><label for="man"><span class="valign-middle">男性</span></label></li>
                                <li class="pull-left"><input name="sex" type="radio" value="2" id="woman"  tabindex="104"><label for="woman"><span class="valign-middle">女性</span></label></li>
                            </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <dl class="clearfix"><dt>携帯電話</dt><dd><input name="tel2" type="text" id="form_tel2" value="" tabindex="112">
                                    <div class="errortxtbox text-alert text-bold pt10"></div>
                                </dd></dl>
            ...
            <section>
                <div class="box-md box-scout box-default text-md clearfix mb40">
                    <dl class="mb15 clearfix">
                        <dt class="pull-left"><input type="checkbox" id="sscout" name="sscout" tabindex="10" value="1" checked="checked"></dt>
                        <dd class="text-bold head pull-left"><label for="sscout">スカウトサービス</label></dd>
                        <dd class="pull-left">あなたのスキルや経験に強く興味をもった企業から、スカウトメールが届きます。<br>転職成功者の70%がスカウトサービスを利用しています。</dd>
                    </dl>
                </div>
            </section>

            <div class="relative text-center">
                <button type="submit" name="confirm" data-role="submit-button" value="1" data-submit-type="data_regist" class="btn btn-xxlg btn-primary btn-wide block-center">Web履歴書を登録する</button>
            </div>
