    ...
    <main>
        <div class="container container-narrow">
            ...
            <form method="post" class="form" name="regist_form" id='regist_form'
                ...
                <input type="hidden" name="user_sid" value="8bfff1fc816d63f6063c56611c2b39d6">
                <input type="hidden" name="skill_sid" value="104b1b8f7b80f7c01d9d3abf2bdb6edb">
                <input type="hidden" name="rireki_sid" value="544e63e8ec1bc1c1a141257725a1f4df">
                ...
                <section>
                    ...
                    <table class="input-cell mb40">
                        <tr>
                            <th>会社名</th>
                            <td>
                                <input tabindex="01" name="office" type="text" class="text-md form_office" value=""
                                       id=comname/>
                                <p class="pt10 text-md"><a href="/help/howto_apply/company_name.html" target="_blank"
                                                           class="icon icon-arrow02-xs">派遣・出向や統合・合併がある場合の社名記入例</a></p>
                            </td>
                        </tr>
                        <tr>
                            <th>勤務期間</th>
                        ...
                        <tr>
                            <th>職務内容</th>
                            <td>
                                <textarea id="rireki_form1" class="form_job_content" tabindex="08"
                                          name="job_content"></textarea>
                                <p class="pt10 text-md"><a href="/help/howto_apply/experience.html"
                                                           class="icon icon-docs-md" target="_blank">職務経歴の記入例</a></p>
                            </td>
                        </tr>
                    </table>
                </section>
                ...
                <div class="relative text-center">
                    <a href="javascript:void(0);" class="btn btn-md btn-default fixed-left" data-role="back-button"
                       tabindex="09">追加しないで戻る</a>
                    <input type="submit" data-role="submit-button" name="rireki_add_form"
                           class="btn btn-xxlg btn-primary btn-wide block-center" value="職務経歴を追加">
                </div>
