...
$(function(){
    ...
    $.validator.addMethod("valid_tel", function(value, element, params) {
        var tel = $('#form_tel').prop('value');
        var tel2 = $('#form_tel2').prop('value');
    ...
    $.validator.addMethod("valid_birthday", function(value, element, params) {
        var year  = $birth_year.prop('value');
        var month = $birth_month.prop('value');
        var day   = $birth_day.prop('value');
    ...
    $.validator.addMethod("valid_g_kubun_required", function(value, element) {
        var year = $('.form_g_year').prop('value');
        var type = $('.form_g_type').prop('value');
    ...
    $.validator.addMethod("valid_start_date", function(value, element, params) {
        var year  = $syear.prop('value');
        var month = $smonth.prop('value');
